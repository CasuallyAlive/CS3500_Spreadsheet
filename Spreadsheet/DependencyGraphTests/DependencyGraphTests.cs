...
namespace DependencyGraphTests
{
    ...
    public class DependencyGraphTests
    {
        ...
        public void StressTest()
        {
            ...
            [TestMethod()]
        public void testReplacingDependents()
        {
            DependencyGraph t = new DependencyGraph();
            t.AddDependency("a", "b"); t.AddDependency("a", "c"); t.AddDependency("a", "z"); t.AddDependency("a", "k");
            t.ReplaceDependents("a", new List<string>() { "y", "u", "f" });
            LinkedList<string> expected = new LinkedList<string>(t.GetDependents("a"));
            LinkedList<string> actual = new LinkedList<string>(new List<string>() { "y", "u", "f" });
            Assert.IsTrue(expected.ToString().Equals(actual.ToString()));
            Assert.AreEqual(3, t.Size);
        }
        [TestMethod()]
        public void testReplacingDependees()
        {
            DependencyGraph t = new DependencyGraph();
            t.AddDependency("a", "b"); t.AddDependency("c", "b"); t.AddDependency("d", "b"); t.AddDependency("q", "b");
            t.ReplaceDependees("b", new List<string>() { "y", "u", "f" });
            LinkedList<string> expected = new LinkedList<string>(t.GetDependees("b"));
            LinkedList<string> actual = new LinkedList<string>(new List<string>() { "y", "u", "f" });
            Assert.IsTrue(expected.ToString().Equals(actual.ToString()));
            Assert.AreEqual(3, t.Size);
        }
        ...
        [TestMethod()]
        public void testAddAlreadyPresentPair()
        {
            DependencyGraph t = new DependencyGraph();
            t.AddDependency("a", "b"); t.AddDependency("c", "b"); t.AddDependency("d", "b"); t.AddDependency("q", "b");
            t.AddDependency("a", "b");
