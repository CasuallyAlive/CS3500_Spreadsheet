...
namespace SS
{
    ...
    public abstract class AbstractSpreadsheet
    {
        ...
        /// 
        /// Visits the cells dependent on name recursively and adds them to a list. 
        /// Throws a circular dependency exception if a cell is re-encountered down the chain of its dependents. 
        /// </summary>
